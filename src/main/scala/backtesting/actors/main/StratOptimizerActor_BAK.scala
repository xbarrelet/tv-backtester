...
//import backtesting.parameters.TVLocator.MA_TYPE.strategyNameXpath
//import backtesting.{BacktestChartResponseMessage, OptimizeParametersListsMessage, BacktestingResultMessage, Message}
//
...
//    message match
//      case OptimizeParametersListsMessage(mainActorRefFromMessage: ActorRef[Message], chartId: String) =>
