...
final case class EnrichedBacktestMessage(parametersToTest: List[ParametersToTest], actorRef: ActorRef[Message], backtesterIndex: Int) extends Message
...
final case class EnrichedBacktestingResultMessage(netProfitsPercentage: Double, closedTradesNumber: Int, profitabilityPercentage: Double,
                                          profitFactor: Double, maxDrawdownPercentage: Double, parameters: List[ParametersToTest], backtesterIndex: Int) extends Message